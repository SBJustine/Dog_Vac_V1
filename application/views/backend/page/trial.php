    ...
    <div class="container-fluid pt-4 px-4">
        <div class="row g-4">
            <div class="col-sm-12 col-xl-6">
                ...
                <form action="<?= base_url() ?>index.php/salary_form" method="post">method="post">
                        ...
                        <div class="row mb-3" style="margin-top:20px"> 
                            <div class="col-md-9">
                                ...
                                // Check if $recent_datePaid is not null or empty
                        ...
                        <label for="floatingInput">Date Payed</label>
                        </div>
                        ...
                        <input type="submit" class="btn btn-maroon custom-button" value="PAY" <?= $numOfDaysPresent == 0 ? 'disabled' : '' ?>>
                        </div>
                    </form>
                </div>
            </div>
