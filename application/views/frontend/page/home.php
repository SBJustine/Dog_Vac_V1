<main> 
       <!--? Slider Area Start-->
<div class="slider-area" style="background-image: url('<?php echo base_url();?>assets/img1/gallery/orig_vetcare1.jpg'); background-size: cover; background-repeat: no-repeat; background-position: center;">
